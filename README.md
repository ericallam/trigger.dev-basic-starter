...
<a href="https://render.com/deploy?repo=https://github.com/ericallam/trigger.dev-basic-starter">
...
```sh
git clone https://github.com/ericallam/trigger.dev-basic-starter.git
cd trigger.dev-basic-starter
npm install
```
